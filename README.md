...
for this app; the whole Animals set, the banana, orange, grapes, cake and
the sparrow, stork, woodpecker, hummingbird, crow and seagull are the
project owner's own pictures. All other pictures are [Twemoji](https://github.com/jdecked/twemoji) graphics,
