...
const STRINGS = {
  en: {
    ...
    matchInputTap: 'Tap the shape, then the slot',
    matchInputScan: 'Scanning',
    matchInputBoth: 'Both',
    matchLayout: 'Slots',
    matchLayoutBelow: 'Below the shapes',
    matchLayoutBeside: 'Beside the shapes',
    matchDeal: 'Where the slots are',
    matchDealAligned: 'Under their own shape (easiest)',
    matchDealRandom: 'Anywhere (random)',
    matchDealCrossed: 'Never under their own shape (hardest)',
  ...
  ka: {
    ...
    matchInputTap: 'დააჭირეთ ფიგურას, მერე სლოტს',
    matchInputScan: 'სკანირება',
    matchInputBoth: 'ორივე',
    matchLayout: 'სლოტები',
    matchLayoutBelow: 'ფიგურების ქვემოთ',
    matchLayoutBeside: 'ფიგურების გვერდით',
    matchDeal: 'სლოტების განლაგება',
    matchDealAligned: 'თავისი ფიგურის ქვეშ (მარტივი)',
    matchDealRandom: 'შემთხვევით',
    matchDealCrossed: 'არასდროს თავისი ფიგურის ქვეშ (რთული)',
    bubbleCount: 'ბუშტების რაოდენობა ერთდროულად',
    bubbleHoldBefore: 'ბუშტის დაჭერა',
    bubbleHoldAfter: 'წამით, რომ გასკდეს',
    bubbleSize: 'ბუშტის ზომა',
    bubbleSizeSmall: 'პატარა',
    bubbleSizeMedium: 'საშუალო',
    bubbleSizeLarge: 'დიდი',
    bubbleSizeXLarge: 'ძალიან დიდი',
  ...
  ru: {
    ...
    matchInputTap: 'Нажать фигуру, затем ячейку',
    matchInputScan: 'Сканирование',
    matchInputBoth: 'Оба способа',
    matchLayout: 'Ячейки',
    matchLayoutBelow: 'Под фигурами',
    matchLayoutBeside: 'Рядом с фигурами',
    matchDeal: 'Расположение ячеек',
    matchDealAligned: 'Под своей фигурой (просто)',
    matchDealRandom: 'Случайно',
    matchDealCrossed: 'Никогда под своей фигурой (сложно)',
    bubbleCount: 'Пузырей одновременно',
    bubbleHoldBefore: 'Удерживать пузырь',
    bubbleHoldAfter: 'сек., чтобы он лопнул',
    bubbleSize: 'Размер пузырей',
    bubbleSizeSmall: 'Маленькие',
    bubbleSizeMedium: 'Средние',
    bubbleSizeLarge: 'Большие',
    bubbleSizeXLarge: 'Очень большие',
    bubbleMotion: 'Пузыри',
