...
const STRINGS = {
  en: {
    title: 'AAC Choice',
    start: 'Start',
    escHint: 'During the game, press Esc to come back here.',
    settings: 'Settings',
    language: 'Language',
    timing: 'Timing',
    intervalBefore: 'Highlight each side for',
  ...
  ka: {
    title: 'AAC არჩევანი',
    start: 'დაწყება',
    escHint: 'თამაშის დროს აქ დასაბრუნებლად დააჭირეთ Esc-ს.',
    settings: 'პარამეტრები',
    language: 'ენა',
    timing: 'დრო',
    intervalBefore: 'თითოეული მხარის მონიშვნა',
    intervalAfter: 'წამით',
