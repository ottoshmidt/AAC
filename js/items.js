...

{
  ...
  itemSets.fruit = [
    ...
    // Page 7: the two mulberries together.
    ...
    item('raspberry', 'ჟოლო', 'Raspberry', 'Малина', 'webp'),
  ];
}
...

{
  ...
  itemSets.transport = [
    ...
    item('bus', 'ავტობუსი', 'Bus', 'Автобус', 'webp'),
    item('minibus', 'მიკროავტობუსი', 'Minibus', 'Маршрутка', 'webp'),
    // Page 2
