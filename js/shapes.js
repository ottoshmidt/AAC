 ...
 *
 * Fields are those of an Item (js/items.js) plus `path` and `color`, so the
 * shapes can be spoken and prepared for a voice like any other picture.
 */

/**
 * @typedef {import('./items.js').Item & { path: string, color: string }} Shape
 */
